...
tooling_docker_cli() {
  ...
  tooling_fail "container tooling requires either a direct codex-user docker context or the codex bridge from a rune shell. Run install-shell-helpers.sh and complete osplan.md, or set TOOLING_ALLOW_PLAIN_DOCKER=1 for a temporary local fallback."
}
